...
/**
 * Created by chopa on 2018. 1. 3..
 */

public class SpeechRecognizerClientImpl {
     ...
     */
    public static final int GLOBAL_TIMEOUT_DEFAULT = 3000;
    ...
    /* package */ SpeechRecognizerClientImpl(SpeechRecognizerClientImpl.Builder builder) {
...
//            printLog("[onReady]");
            ...
            synchronized (SpeechRecognizerClientImpl.this) {
                beforeReady = false;
            }
...
//            printLog("[onFinalResultConf]");

//            for(int i=0; i<texts.length; i++) {
//                printLog("texts : [" + texts[i] + "]");
//            }
//
//            for(int i=0; ints != null && i < ints.length; i++) {
//                printLog("ints : [" + ints[i] + "]");
//            }
...
//            printLog("[onEnergyChanged] energy : " + energy);
...
//            printLog("[onBeginPointDetect]");
     ...
     */
    public boolean startRecording(final boolean mute, final SpeechReader reader) {
        try {
            ...
            synchronized (this) {
                ...
                speechRecognizer = SpeechRecognizer.getInstance(reader);
...
//                speechRecognizer.setSendSpeechInterval(0);
//                speechRecognizer.setTimeout(360000);
//                speechRecognizer.setRecognitionInterval(0);
//                speechRecognizer.setRecordSpeechInterval(0);
...
//            audioManager.setStreamMute(AudioManager.STREAM_MUSIC, false);
    ...
    private void cancelSpeechRecognizer() {
        synchronized (this) {
            if (speechRecognizer != null) {
                ...
                if (speechRecognizer.cancel()) {
                    speechRecognizer.join();
                }
            }
    ...
    public static class Builder {
         ...
         */
        @Deprecated
        public SpeechRecognizerClientImpl.Builder setApiKey(String apiKey) {
            this.apiKey = apiKey;
            return this;
        }
         ...
         * 반드시 설정해야 하는 값이다.
         */
        public SpeechRecognizerClientImpl.Builder setAppKey(String appKey) {
            this.appKey = appKey;
            return this;
        }
         ...
         */
        public SpeechRecognizerClientImpl.Builder setGlobalTimeOut(int globalTimeOut) {
         ...
         * 단어/문장/지역 인식을 선택한다.
         */
        public SpeechRecognizerClientImpl.Builder setServiceType(String serviceType) {
         ...
         */
        @SuppressWarnings("unused")
        public SpeechRecognizerClientImpl.Builder setUserDictionary(String userDictionary) {
         ...
         */
        public SpeechRecognizerClientImpl build() throws IllegalArgumentException {
